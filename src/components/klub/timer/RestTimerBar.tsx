...
import { formatDuration } from '@/lib/klub/format'

/**
 * Plávajúci panel bežiaceho odpočinku – viditeľný v celej členskej zóne
...
export function RestTimerBar() {
  ...
  const hidden = pathname === '/klub/casovac'
          ...
          >
            <div className="relative flex min-w-0 flex-1 flex-col">
              ...
              <div className="absolute -bottom-3 left-0 right-0 h-0.5 rounded bg-line">
                <div
                  className="h-full rounded bg-gold transition-[width] duration-300"
            ...
            {timer.activeTimer && (
              <>
                <button
                  ...
                  className="flex h-11 items-center gap-0.5 rounded-xl bg-surface-3 px-2.5 text-xs font-bold text-ink-dim hover:text-ink"
                >
                ...
                <button
                  ...
                  className="flex size-11 items-center justify-center rounded-xl bg-gold text-bg hover:bg-gold-hi"
                >
                  {timer.running ? (
                ...
                <button
                  ...
                  onClick={timer.stop}
                  className="flex size-11 items-center justify-center rounded-xl text-ink-dim hover:bg-surface-3 hover:text-ink"
                >
