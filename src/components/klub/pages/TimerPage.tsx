  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="display text-2xl text-ink">Časovač odpočinku</h1>
      ...
      {timer.activeTimer ? (
        <div className="space-y-3">
          <div className="flex justify-center gap-3">
            ...
            <Button size="lg" className="min-w-36" onClick={timer.running ? timer.pause : timer.resume}>
              {timer.running ? (
                <>
          ...
          <div className="grid grid-cols-4 gap-2">
            {PRESETS.map((sec) => (
              <button
                ...
                className="tnum h-14 rounded-xl border border-line bg-surface text-base font-bold text-ink transition-colors hover:border-gold/50 hover:bg-gold/10 hover:text-gold-hi"
              >
                {sec} s
              </button>
            ))}
